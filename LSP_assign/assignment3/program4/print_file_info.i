...
int main(int argc, char *argv[])
{
 ...
 struct stat sb;
 int ret;
 char FilePermissionString[sizeof("rwxrwxrwx")];
 mode_t perm;
 ...
 printf("\nDevice: \t Major number:%ld\t Minor number:%ld \n", (long)gnu_dev_major (sb.st_dev), (long)gnu_dev_minor (sb.st_dev));
 printf("\nInode Number: %ld\n", (long)sb.st_ino);
 ...
 snprintf(FilePermissionString,
   ...
   (perm & (0400 >> 3)) ? 'r' : '-',(perm & (0200 >> 3)) ? 'w' : '-',(perm & (0100 >> 3)) ? 'x' : '-',
   (perm & ((0400 >> 3) >> 3)) ? 'r' : '-',(perm & ((0200 >> 3) >> 3)) ? 'w' : '-',(perm & ((0100 >> 3) >> 3)) ? 'x' : '-'
  );
